...
Khu vực cửa ngõ đầu mối đường sắt cao tốc Nghi Tân, Tứ Xuyên vừa khánh thành. Với nòng cốt là nhà ga đường sắt cao tốc, khu phức hợp bao gồm 8 tòa tháp, công viên trung tâm, trung tâm nghệ thuật kỹ thuật số và phố văn hóa thương mại. ([via](http://www.archina.com/index.php?g=works&m=index&a=show&id=159920))
...
Tháng này, ông lại vừa đăng [một bài viết mới](https://steve-yegge.medium.com/welcome-to-gas-town-4f25ee16dd04) chia sẻ góc nhìn về lập trình AI.
...
Dẫu vậy, ông vẫn đưa [công cụ này](https://github.com/steveyegge/gastown) lên mạng vì nó rất thú vị. Tính đến tuần trước, nó đã nhận được 6.000 sao trên GitHub.

![](https://cdn.beekka.com/blogimg/asset/202601/bg2026012420.webp)

## Tin tức công nghệ

1. [Trí thông minh của bò](https://www.theguardian.com/science/2026/jan/19/back-scratching-cow-veronika-bovine-intelligence)
...
2. [Hệ thống lưu trữ năng lượng bằng đường ray](https://aresnorthamerica.com/)
...
3. [Miếng dán phát âm vùng cổ](https://newsroom.ucla.edu/releases/speaking-without-vocal-cords-ucla-engineering-wearable-tech)
...
1. [Trình phát nhạc Linux năm 2026](https://crescentro.se/posts/linux-music-players-2026/) (Tiếng Anh)
...
2. [Vô hiệu hóa có chọn lọc HTTP/1.0 và HTTP/1.1](https://markmcb.com/web/selectively_disabling_http_1/) (Tiếng Anh)
...
3. [Tôi đã quét toàn bộ các "orphan commit" trên GitHub](https://trufflesecurity.com/blog/guest-post-how-i-scanned-all-of-github-s-oops-commits-for-leaked-secrets) (Tiếng Anh)
...
4. [Bộ đếm hoạt họa bằng CSS](https://css-tricks.com/animating-number-counters/) (Tiếng Anh)

![](https://cdn.beekka.com/blogimg/asset/202507/bg2025070317.webp)

Bài viết giới thiệu các cách viết bộ đếm số bằng CSS thuần.

5. [Những use case n8n của tôi](https://www.xda-developers.com/built-expense-tracker-using-n8n/) (Tiếng Anh)
...
6. [Những kiến thức mới về HTML năm 2025 nên biết](https://frontendmasters.com/blog/bone-up-html-2025/) (Tiếng Anh)
...
7. [Đề xuất các ứng dụng tự host (self-hosted) mới](https://selfh.st/2024-favorite-new-apps/) (Tiếng Anh)
...
4. [Phân Cảnh Đại Sư](https://github.com/BroderQi/Storyboard) (Storyboard Studio)
...
1. [Claude Code thực chiến](https://anthropic.skilljar.com/claude-code-in-action) (Claude Code in Action)

Khóa học nhập môn Claude Code miễn phí chính thức từ Anthropic với 15 bài học video, tổng thời lượng khoảng 1 tiếng.

2. [Chứng nhận GitHub](https://certificate.brendonmatos.com/)
...
4. [Bảng tuần hoàn phong cách tương lai](https://github.com/SeanWong17/Future-Style-Periodic-Table)
...
1. [Tôi không còn viết code nữa, tôi đang điêu khắc nó](https://www.jerpint.io/blog/2026-01-24-i-dont-write-code-anymore-i-sculpt-it/)
...
2. [Bích họa bướm](https://www.mantrarea.com/murals)
...
1. [Tại sao một số công ty chấp nhận "lập trình hộp đen"](https://simonwillison.net/2026/Jan/28/the-five-levels/)
...
-- [ "20 năm thực hành DevOps"](https://www.honeycomb.io/blog/you-had-one-job-why-twenty-years-of-devops-has-failed-to-do-it)
...
-- [ "Thế nào là tài liệu tốt và viết chúng như thế nào"](https://stevelosh.com/blog/2013/09/teach-dont-tell/)
...
-- [ "Họ đã lừa bạn, xây dựng phần mềm thực sự rất khó"](https://toddle.dev/blog/they-lied-to-you-building-software-is-really-hard)
...
-- [ "Có AI, tôi trở nên lười biếng và ngốc nghếch"](https://thomasorus.com/i-tried-coding-with-ai-i-became-lazy-and-stupid)

## Nhìn lại các năm trước

[Trước ngưỡng cửa AI, internet đang lụi tàn](https://www.ruanyifeng.com/blog/2025/02/weekly-issue-336.html) (#336)

[Giải pháp cho đèn chỉ báo màu xanh lam](https://www.ruanyifeng.com/blog/2024/01/weekly-issue-286.html) (#286)

[Vùng đất ngập nắng của Trung Quốc](https://www.ruanyifeng.com/blog/2022/12/weekly-issue-236.html) (#236)

[Vĩ độ thấp, độ cao lớn, ưu thế khí hậu](https://www.ruanyifeng.com/blog/2021/12/weekly-issue-186.html) (#186)
